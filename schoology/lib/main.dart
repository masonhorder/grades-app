...
import 'package:schoology/api/api.dart';
...
void main() {
  OAuthSchoology oauthInstance = OAuthSchoology();
  oauthInstance.reqAuth();
  // var platform = new oauth1.Platform(
  //     'https://api.schoology.com/v1/oauth/request_token', // temporary credentials request
  //     'https://srvusd.schoology.com/oauth/authorize',     // resource owner authorization
  //     'https://api.schoology.com/v1/oauth/access_token',  // token credentials request
  //     oauth1.SignatureMethods.hmacSha1              // signature method
  //     );

  // // define client credentials (consumer keys)
  // const String apiKey = 'e3c2632f9add6e8f11a3c214a7a9bf92062f9e326';
  // const String apiSecret = '224e200d7904df32d90ebcf049dabe7b';
  ...
  // auth.requestTemporaryCredentials('https://srvusd.schoology.net').then((res) {
